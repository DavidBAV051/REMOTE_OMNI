...
void BOARD_InitPins(void)
{
    ...
    const port_pin_config_t port2_0_pinH3_config = {/* Internal pull-up/down resistor is disabled */
													kPORT_PullDisable,
													/* Low internal pull resistor value is selected. */
													kPORT_LowPullResistor,
													/* Fast slew rate is configured */
	...
	PORT_SetPinConfig(PORT2, 0U, &port2_0_pinH3_config);
...
//    PORT_SetPinConfig(PORT2, 7U, &port2_7_pinL2_config);
    ...
    const port_pin_config_t port2_8_pinL2_config = {/* Internal pull-up/down resistor is disabled */
                                                    kPORT_PullDisable,
                                                    /* Low internal pull resistor value is selected. */
                                                    kPORT_LowPullResistor,
                                                    /* Fast slew rate is configured */
                                                    ...
                                                    /* Pin Control Register fields [15:0] are not locked */
                                                    kPORT_UnlockRegister};
    /* PORT2_7 (pin L2) is configured as PWM1_X0 */
    PORT_SetPinConfig(PORT2, 8U, &port2_8_pinL2_config);
...
/* FUNCTION ************************************************************************************************************
 *
 * Function Name : BOARD_InitCapturePins
 * Description   : Configures pin routing and optionally pin electrical features.
 *
 * END ****************************************************************************************************************/

void BOARD_InitCapturePins(void){
	/* PORT4_0 configured as CT_INP16 (Motor 1) */
	// (You already have this block, keep it)
	const port_pin_config_t port4_0_config = {
	    ...
	    kPORT_MuxAlt4, // CT_INP16
	    kPORT_InputBufferEnable, kPORT_InputNormal, kPORT_UnlockRegister
	};
	PORT_SetPinConfig(PORT4, 0U, &port4_0_config);

	/* PORT4_1 configured as CT_INP17 (Motor 2) */
	const port_pin_config_t port4_1_config = {
	    kPORT_PullDisable, kPORT_LowPullResistor, kPORT_FastSlewRate,
	    kPORT_PassiveFilterDisable, kPORT_OpenDrainDisable, kPORT_LowDriveStrength,
	    kPORT_MuxAlt4, // CT_INP17
	    kPORT_InputBufferEnable, kPORT_InputNormal, kPORT_UnlockRegister
	};
	PORT_SetPinConfig(PORT4, 1U, &port4_1_config);

	/* PORT0_28 configured as CT_INP0 (Motor 3) */
	const port_pin_config_t port0_8_config = {
	    kPORT_PullDisable, kPORT_LowPullResistor, kPORT_FastSlewRate,
	    kPORT_PassiveFilterDisable, kPORT_OpenDrainDisable, kPORT_LowDriveStrength,
	    kPORT_MuxAlt4, // CT_INP0
	    kPORT_InputBufferEnable, kPORT_InputNormal, kPORT_UnlockRegister
	};
	PORT_SetPinConfig(PORT0, 8U, &port0_8_config);

	/* PORT0_29 configured as CT_INP1 (Motor 4) */
	const port_pin_config_t port0_9_config = {
	    kPORT_PullDisable, kPORT_LowPullResistor, kPORT_FastSlewRate,
	    kPORT_PassiveFilterDisable, kPORT_OpenDrainDisable, kPORT_LowDriveStrength,
	    kPORT_MuxAlt4, // CT_INP1
	    kPORT_InputBufferEnable, kPORT_InputNormal, kPORT_UnlockRegister
	};
	PORT_SetPinConfig(PORT0, 9U, &port0_9_config);
}

void BOARD_ADCPins(void){
	 // --- MOTOR CURRENT SENSING PINS (ADC) ---

	    /* M1 Current: PORT4_23 configured as ADC0_A2/ADC0_B2 */
	    const port_pin_config_t port4_23_adc_config = {
	        kPORT_PullDisable,
	        kPORT_LowPullResistor,
	        kPORT_FastSlewRate,
	        kPORT_PassiveFilterDisable,
	        kPORT_OpenDrainDisable,
	        kPORT_LowDriveStrength,
	        kPORT_MuxAlt0,             /* ALT0 is Analog */
	        kPORT_InputBufferDisable,  /* Digital Input Buffer MUST be Disabled */
	        kPORT_InputNormal,
	        kPORT_UnlockRegister
	    };
	    PORT_SetPinConfig(PORT4, 23U, &port4_23_adc_config);

	    /* M2 Current: PORT0_16 configured as ADC0_A8 */
	    const port_pin_config_t port4_15_adc_config = {
	        kPORT_PullDisable,
	        kPORT_LowPullResistor,
	        kPORT_FastSlewRate,
	        kPORT_PassiveFilterDisable,
	    ...
	    PORT_SetPinConfig(PORT4, 15U, &port4_15_adc_config);

	    /* M3 Current: PORT0_17 configured as ADC0_A9 */
	    const port_pin_config_t port4_12_adc_config = {
	        kPORT_PullDisable,
	        kPORT_LowPullResistor,
	        kPORT_FastSlewRate,
	        kPORT_PassiveFilterDisable,
	    ...
	    PORT_SetPinConfig(PORT4, 12U, &port4_12_adc_config);

	    /* M4 Current: PORT0_18 configured as ADC0_A10 */
	    const port_pin_config_t port4_16_adc_config = {
	        kPORT_PullDisable,
	        kPORT_LowPullResistor,
	        kPORT_FastSlewRate,
	        kPORT_PassiveFilterDisable,
	    ...
	    PORT_SetPinConfig(PORT4, 16U, &port4_16_adc_config);
}
